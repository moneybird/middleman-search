  ...
  module Sitemap
    class SearchIndexResource < ::Middleman::Sitemap::Resource
      ...
      def build_index
        ...
        context.load(lunr_resource('elasticlunr.min.js'))
        ...
        context.eval('elasticlunr.Index.prototype.indexJson = function () {return JSON.stringify(this.toJSON());}')

        # Register pipeline functions
        pipeline = context.eval('elasticlunr.Pipeline')
        ...
        @app.sitemap.resources.each_with_index do |resource, id|
          begin
              ...
              index.addDoc(to_index.merge(id: id))
              store[id] = to_store
            end
          rescue => ex
